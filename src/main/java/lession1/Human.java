...
public class Human implements Participant {
    ...
    public Human(String type,String name,int maxJump,int maxRun) {
        this.type=type;
        this.name=name;
        this.maxRun=maxRun;
    ...
    @Override
    public int run() {
        System.out.printf("Человек %s бежит дистанцию %d%n",type,maxRun);
        return maxRun;
    }

    @Override
    public int jump() {
        System.out.printf("Человек %s прыгнул на %d%n",type,maxJump);
        return maxJump;
    }
}
