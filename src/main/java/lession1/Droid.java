...
public class Droid implements Participant{
    private final String type;
    private final String name;
    private final int maxJump;
    private final int maxRun;

    public Droid(String type,String name,int maxJump,int maxRun) {
        this.type=type;
        this.name=name;
        this.maxRun=maxRun;
    ...
    @Override
    public int run() {
        System.out.printf("Робот %s бежит дистанцию %d%n",type,maxRun);
        return maxRun;
    }

    @Override
    public int jump() {
        System.out.printf("Робот %s прыгнул на %d%n",type,maxJump);
        return maxJump;
    }
}
